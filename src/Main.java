...
public class Main {
    public static void main(String[] args) {
        /**
         ...
         P.S. Возможно, после того, как правое число(m) будет доведено до максимума, оставшуюся, неотсортированную часть нужно досортировать,
         вот только я не знаю, с какими сислами свапать, если правая чусть уже достигла лимита массива.
         */
